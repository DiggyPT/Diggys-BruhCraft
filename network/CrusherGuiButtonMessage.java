...
import net.mcreator.diggysbruhcraft.procedures.CrusherInputItemProcedure;
...
public class CrusherGuiButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			CrusherInputItemProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DiggysBruhcraftMod.addNetworkMessage(CrusherGuiButtonMessage.class, CrusherGuiButtonMessage::buffer, CrusherGuiButtonMessage::new, CrusherGuiButtonMessage::handler);
	}
}
