...
import net.mcreator.diggysbruhcraft.procedures.GrimaceShakePlayerFinishesUsingItemProcedure;
...
public class GrimaceShakeItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		GrimaceShakePlayerFinishesUsingItemProcedure.execute(entity);
