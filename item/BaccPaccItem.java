...
import net.mcreator.diggysbruhcraft.item.inventory.BaccPaccInventoryCapability;
...
public class BaccPaccItem extends Item {
	public BaccPaccItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.diggys_bruhcraft.bacc_pacc.description_0"));
	}
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Bacc Pacc");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new BaccPaccGuiMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new BaccPaccInventoryCapability();
	}
