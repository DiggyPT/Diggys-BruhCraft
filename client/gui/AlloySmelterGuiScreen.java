...
import net.mcreator.diggysbruhcraft.network.AlloySmelterGuiButtonMessage;
...
public class AlloySmelterGuiScreen extends AbstractContainerScreen<AlloySmelterGuiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("diggys_bruhcraft:textures/screens/alloy_smelter_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.diggys_bruhcraft.alloy_smelter_gui.label_crusher"), 4, 6, -12829636, false);
	...
	public void init() {
		super.init();
		imagebutton_startup_normal = new ImageButton(this.leftPos + 13, this.topPos + 32, 16, 16, 0, 0, 16, new ResourceLocation("diggys_bruhcraft:textures/screens/atlas/imagebutton_startup_normal.png"), 16, 32, e -> {
			if (true) {
				DiggysBruhcraftMod.PACKET_HANDLER.sendToServer(new AlloySmelterGuiButtonMessage(0, x, y, z));
				AlloySmelterGuiButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
