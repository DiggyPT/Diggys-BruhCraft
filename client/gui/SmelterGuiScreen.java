...
import net.mcreator.diggysbruhcraft.network.SmelterGuiButtonMessage;
...
public class SmelterGuiScreen extends AbstractContainerScreen<SmelterGuiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("diggys_bruhcraft:textures/screens/smelter_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.diggys_bruhcraft.smelter_gui.label_crusher"), 4, 6, -12829636, false);
	...
	public void init() {
		super.init();
		imagebutton_startup_normal = new ImageButton(this.leftPos + 32, this.topPos + 30, 16, 16, 0, 0, 16, new ResourceLocation("diggys_bruhcraft:textures/screens/atlas/imagebutton_startup_normal.png"), 16, 32, e -> {
			if (true) {
				DiggysBruhcraftMod.PACKET_HANDLER.sendToServer(new SmelterGuiButtonMessage(0, x, y, z));
				SmelterGuiButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
